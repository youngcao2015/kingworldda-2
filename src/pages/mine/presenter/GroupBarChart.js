...
export default class GroupBarChart extends React.Component {
    constructor(props) {
        ...
        let barCount = props.dataSets.length;
        let groupSpace = 0.3;
        let barSpace = 0.1;
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps !== this.props) {
            let barCount = nextProps.dataSets.length;
            let groupSpace = 0.3;
            let barSpace = 0.1;
            let barWidth = (1 - groupSpace) / barCount - barSpace;
            this.setState({
                ...
                xAxis: {
                    valueFormatter: nextProps.valueFormatter,
                    granularityEnabled: true,
                    granularity: 1,
                    axisMaximum: nextProps.valueFormatter.length,
                    axisMinimum: 0,
                    centerAxisLabels: true,
                    position: 'BOTTOM',
                    drawAxisLine: false,
